...
std::unique_ptr<Menu> ScreenRecoveryUI::CreateMenu(const std::vector<std::string>& text_headers,
                                                   ...
                                                   size_t initial_selection) const {
  int menu_char_width = menu_draw_funcs_->MenuCharWidth();
  int menu_char_height = menu_draw_funcs_->MenuCharHeight();
  int menu_item_padding = menu_draw_funcs_->MenuItemPadding();
