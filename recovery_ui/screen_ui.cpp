...
void ScreenRecoveryUI::draw_battery_capacity_locked() {
  ...
  if (menu_) {
    ...
    gr_text(gr_sys_font(), x, icon_y, batt_capacity.c_str(), false);
  }
}
...
void ScreenRecoveryUI::BattMonitorThreadLoop() {
  ...
  while (!batt_monitor_thread_stopped_) {
    bool redraw = false;
    {
      ...
      android::BatteryMonitor batt_monitor;
      ...
      batt_capacity = static_cast<int32_t>(prop.valueInt64);
      ...
      charging = (charge_status != BatteryStatus::DISCHARGING &&
